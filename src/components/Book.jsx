...
import Filter from "@material-ui/icons/Edit";
...
function Book() {
	...
	const [date, setDate] = useState(["Jan, 29, 2021"]);
	const [clas, setClas] = useState(["1 Traveller, Economy"]);
		...
		<div>
			...
			<div id='try'>
				...
				<div id='box1'>
					...
					<div>
						<input type='text' className='i' value={from} onChange={handle} />
					</div>
				</div>
				...
				<div id='box3'>
					...
					<div>
						<input type='text' className='i' value={to} onChange={handles} />
					</div>
				</div>
				<div id='box4'>
					<div className='fs'>Date</div>
					<div>
						<input type='text' className='i' value={date} onChange={handle} />
					</div>
				</div>
				<div id='box5'>
			...
			<div id='filter'>
				<div style={{ float: "left" }}>
					...
					<div style={{ marginLeft: "62px", fontSize: "13px" }}>Filters</div>
				</div>
				<div style={{ float: "left" }}>
					<div style={{ float: "left", marginTop: "15px", marginLeft: "30px" }}>
						Stops:
					</div>
					<div
						style={{ float: "left" }}
						...
						<div className='ticket'>
							<div>
								...
								<span className='flash'>
									Use code - FLASH24 and Get Flat Rs. 550 OFF per pax (upto Rs.
									2021).
								</span>
							</div>
							...
							<div>
								...
								<div style={{ float: "left" }}>
									<button className='far'>Book</button>
								</div>
